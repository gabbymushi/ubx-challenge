        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" onclick="createBill('{{$charge->id}}','destuffing')"></td>
                                    <td>{{$key+1}}</td>
            ...
            <div class="row" style="margin-top: 5px;">
                <div class="col-md-3 offset-md-9">
                    <a href="/storage" class="btn btn-warning" style="width: 90px;">PREVIOUS</a>
                    <a href="/lifting" class="btn btn-primary" style="width: 90px;">NEXT</a>
                </div>
            </div>
        </section>
    </div>
